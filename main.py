...
class SnakePositionSchema(BaseModel):
    ...
    created_at: Annotated[
        datetime, Field(description="The created at date of the snake position")
    ]
...
def update_player(
    id: int, direction: Direction, session: Annotated[Session, Depends(get_session)]
):
...
# note that on_event seems to be a deprecated feature
